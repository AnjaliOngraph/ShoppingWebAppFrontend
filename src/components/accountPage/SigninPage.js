                        ...
                        <input
                          ...
                          className={
                            errors.password && touched.password
                              ? "relative block w-full appearance-none rounded-none rounded-b-md border border-red-500 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm mt-4 "
                              : "relative block w-full appearance-none rounded-none rounded-b-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-lime-500 focus:outline-none focus:ring-lime-500 sm:text-sm mt-4 "
                          }
                          placeholder="Password"
                        />
                        {errors.password && touched.password && (
                          <span className="text-red-600 text-xs mt-2  m-3">
                            {errors.password}
                          </span>
                        )}
                      </div>
