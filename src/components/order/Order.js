...
export default function Orders() {
  ...
  return (
    <div>
              ...
              <table className="table-auto w-full  bg-gray-100  ">
                <thead className="">
                  <tr className="border-b-2  border-gray-400">
                    <th className="p-3 pl-8 w-5/12 text-left">ITEM DESCRIPTION</th>
      ...
      <div className="m-10">
        <a href="/" className=" items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-lime-600  mt-6 p-2 text-x font-bold  text-white shadow-sm hover:bg-lime-700 hover:shadow-md hover:shadow-lime-400">Back To Home</a>
      </div>
      </div>
